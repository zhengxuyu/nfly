...
from nfly.cli import add_agent_args, add_connectome_args, agent_kwargs, apply_freezes, calibrate_on, connectome_from_args, rescale_policy
...
def main() -> None:
    ...
    if args.eval_only or args.eval_every:
        evaluation = EvaluationConfig(episodes=args.eval_episodes, seed=args.eval_seed,
                                      temperatures=tuple(args.eval_temperatures), output=args.eval_json)
